...
CREATE TABLE IF NOT EXISTS `db_final_boss`.`pedido` (
  ...
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_pedido_clientes_idx` (`clientes_id` ASC) ,
  INDEX `fk_pedido_usuarios1_idx` (`usuarios_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_final_boss`.`pedido_produtos` (
  ...
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_produtos_has_pedido_pedido1_idx` (`pedido_id` ASC, `pedido_clientes_id` ASC) ,
  INDEX `fk_produtos_has_pedido_produtos1_idx` (`produtos_id` ASC) ,
