...
INSERT INTO `clientes` VALUES (1,'Vanderson','27999295178','eu@mail.com',0),(2,'Vanderson1','27999295178','eu@mail.com1',0);
...
INSERT INTO `produtos` VALUES (1,'SORVETE LUIGI 1,5lt','Sorvetes',22.50,1000,1),(2,'COCA-COLA 2lts','Bebida',14.70,1000,1),(3,'COXINHA DE FRANGO','Salgados',0.65,1000,1),(4,'BOLINHA DE QUEIJO','Salgados',0.65,1000,1),(5,'Arroz 10kg','Arroz branco tipo 1',29.00,50,1),(6,'Arroz 10kg','Arroz branco tipo 1',29.00,50,1),(7,'Feijão 1,5kg','Feijão carioca',6.20,50,1),(8,'Arroz 100kg','Arroz branco tipo 1',55.10,50,1),(9,'Arroz 110kg','Arroz branco tipo 1',201.00,50,1),(10,'Feijão 1,5kg','Feijão carioca',35.00,50,1),(11,'Feijão 1,5kg','Feijão carioca',35.00,7,1),(12,'Feijão 1,5kg','Feijão carioca',101.00,7,1),(13,'Feijão 1,5kg','Feijão carioca',200.00,20,1);
...
CREATE TABLE `usuarios` (
  ...
  `tipo` enum('Administrador','Atendente') DEFAULT 'Atendente',
...
INSERT INTO `usuarios` VALUES (1,'ErreSete','eu1@gmail.com','Administrador','1'),(2,'Vanderson','eu@gmail.com','Administrador','1'),(3,'Pietra','eu2@gmail.com','Administrador','1');
...
-- Dump completed on 2025-07-07 16:53:13
